...
public class RealtimeSessionCreateRequestTurnDetection {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `create_response` to the URL query string
    if (getCreateResponse() != null) {
      try {
        joiner.add(String.format("%screate_response%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCreateResponse()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
