...
public class ModifyMessageRequest {
  ...
  public ModifyMessageRequest metadata(@javax.annotation.Nullable Map<String, String> metadata) {
    this.metadata = JsonNullable.<Map<String, String>>of(metadata);
    
    return this;
  }

  public ModifyMessageRequest putMetadataItem(String key, String metadataItem) {
