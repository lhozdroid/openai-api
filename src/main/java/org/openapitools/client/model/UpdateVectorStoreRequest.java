...
public class UpdateVectorStoreRequest {
  ...
  @javax.annotation.Nullable
  private UpdateVectorStoreRequestExpiresAfter expiresAfter;
  ...
  public UpdateVectorStoreRequest expiresAfter(@javax.annotation.Nullable UpdateVectorStoreRequestExpiresAfter expiresAfter) {
  ...
  public UpdateVectorStoreRequestExpiresAfter getExpiresAfter() {
    return expiresAfter;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EXPIRES_AFTER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExpiresAfter(@javax.annotation.Nullable UpdateVectorStoreRequestExpiresAfter expiresAfter) {
    this.expiresAfter = expiresAfter;
  }

  public UpdateVectorStoreRequest metadata(@javax.annotation.Nullable Map<String, String> metadata) {
    this.metadata = JsonNullable.<Map<String, String>>of(metadata);
    
    return this;
  }

  public UpdateVectorStoreRequest putMetadataItem(String key, String metadataItem) {
