...
public class CreateVectorStoreRequest {
  ...
  public CreateVectorStoreRequest metadata(@javax.annotation.Nullable Map<String, String> metadata) {
    this.metadata = JsonNullable.<Map<String, String>>of(metadata);
    
    return this;
  }

  public CreateVectorStoreRequest putMetadataItem(String key, String metadataItem) {
