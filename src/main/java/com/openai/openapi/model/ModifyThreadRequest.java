...
public class ModifyThreadRequest {
  ...
  public JsonNullable<ModifyThreadRequestToolResources> getToolResources_JsonNullable() {
    return toolResources;
  }
  
  @JsonProperty(JSON_PROPERTY_TOOL_RESOURCES)
  public void setToolResources_JsonNullable(JsonNullable<ModifyThreadRequestToolResources> toolResources) {
