...
public class MessageObjectIncompleteDetails {
  ...
  public enum ReasonEnum {
    ...
    MAX_TOKENS(String.valueOf("max_tokens")),
    
    RUN_CANCELLED(String.valueOf("run_cancelled")),
    
    RUN_EXPIRED(String.valueOf("run_expired")),
    
    RUN_FAILED(String.valueOf("run_failed"));
