...
import com.openai.openapi.model.RealtimeServerEventRateLimitsUpdatedRateLimitsInner;
...
public class RealtimeServerEventRateLimitsUpdated {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `rate_limits` to the URL query string
    if (getRateLimits() != null) {
      for (int i = 0; i < getRateLimits().size(); i++) {
        if (getRateLimits().get(i) != null) {
          joiner.add(getRateLimits().get(i).toUrlQueryString(String.format("%srate_limits%s%s", prefix, suffix,
