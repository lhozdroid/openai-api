...
public class RealtimeResponseUsageInputTokenDetails {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `text_tokens` to the URL query string
    if (getTextTokens() != null) {
      try {
        joiner.add(String.format("%stext_tokens%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTextTokens()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
