...
import com.openai.openapi.model.UsageTimeBucket;
...
public class UsageResponse {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `next_page` to the URL query string
    if (getNextPage() != null) {
      try {
        joiner.add(String.format("%snext_page%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getNextPage()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
