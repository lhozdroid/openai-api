 ...
 */
@JsonPropertyOrder({
  ThreadStreamEventOneOf.JSON_PROPERTY_ENABLED,
...
public class ThreadStreamEventOneOf {
  ...
  public ThreadStreamEventOneOf enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public ThreadStreamEventOneOf event(@javax.annotation.Nonnull EventEnum event) {
  ...
  public ThreadStreamEventOneOf data(@javax.annotation.Nonnull ThreadObject data) {
