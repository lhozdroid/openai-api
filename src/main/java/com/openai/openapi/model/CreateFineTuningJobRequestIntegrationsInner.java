...
import com.openai.openapi.model.CreateFineTuningJobRequestIntegrationsInnerType;
import com.openai.openapi.model.CreateFineTuningJobRequestIntegrationsInnerWandb;
...
public class CreateFineTuningJobRequestIntegrationsInner {
  ...
  public CreateFineTuningJobRequestIntegrationsInner type(@javax.annotation.Nonnull CreateFineTuningJobRequestIntegrationsInnerType type) {
  ...
  @JsonProperty(JSON_PROPERTY_TYPE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setType(@javax.annotation.Nonnull CreateFineTuningJobRequestIntegrationsInnerType type) {
    this.type = type;
  }
